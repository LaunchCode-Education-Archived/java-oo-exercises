...
public class Student2 {
	...
	public Student2(String firstName, String lastName, int studentID) {
	...
	public Student2(String firstName, String lastName, int studentID, int credits, double GPA) {
		this.name = firstName + " " + lastName;
		this.studentID = studentID;
	...
	public Student2 createLegacy(Student2 firstParent, Student2 secondParent) {
		return new Student2(
				firstParent.getName(),
