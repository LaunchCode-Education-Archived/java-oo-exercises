...
public class Student {
	...
	public double computeTuition() {
		...
		if (this.credits < 15) {
			...
			return semesters * 20000;
		} else {
			return (semesters * 20000) + 20000; 
		}
	}
	...
	public Student createLegacy(Student s) {
		...
		bb.setStudentID(this.studentID + s.studentID);
		bb.setGPA((this.GPA + s.GPA) / 2.0);
		bb.setCredits(Math.max(this.credits, s.credits));
		return bb;
	}
